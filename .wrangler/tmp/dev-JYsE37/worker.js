...
// .wrangler/tmp/bundle-yUSYpD/checked-fetch.js
...
function buildElectionsIntelligencePayload(options = {}) {
  ...
  return {
    mayors: {
      overview: {
        ...MAYORS_OVERVIEW,
        keyPoliticalPicture: [...MAYORS_OVERVIEW.whatMatters || []]
      },
      regional: cloneArray(REGIONAL_MAYORS),
      council: cloneArray(COUNCIL_MAYORS),
      meta: {
        updatedAt,
    ...
    devolved: {
      overview: {
        ...DEVOLVED_OVERVIEW,
        keyStrategicQuestion: DEVOLVED_NATIONS.map((nation) => nation.keyStrategicQuestion).filter(Boolean).join(" ")
      },
      nations: cloneArray(DEVOLVED_NATIONS),
      meta: {
        updatedAt,
...
// .wrangler/tmp/bundle-yUSYpD/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-yUSYpD/middleware-loader.entry.ts
