...
// .wrangler/tmp/bundle-i8H7m8/checked-fetch.js
...
var worker_default = {
  async fetch(request, env) {
    ...
    if (request.method === "GET" && url.pathname.startsWith("/api/debug/council/")) {
      ...
      const rawRow = Array.isArray(rawStatus) ? rawStatus.find((item) => String(item?.slug || "").toLowerCase() === slug) || null : null;
...
// .wrangler/tmp/bundle-i8H7m8/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-i8H7m8/middleware-loader.entry.ts
