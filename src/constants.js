...
export const SPACING = {
  ...
  gutter:   16,   // gap between cards (mobile)
  gutterMd: 20,   // tablet
  gutterLg: 24,   // desktop
}
...
export const APP_VERSION = 'v21V2.03'
export const APP_UPDATED = '26 Mar 2026'
export const API_BASE = 'https://politiscope-api.craighow8.workers.dev'