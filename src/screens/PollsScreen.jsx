...
import { TrendsPanel } from './TrendsScreen'
...
export default function PollsScreen({ T, parties, polls, meta, nav, pollContext = {}, trends = [], milestones = [], dataState = {}, initialTab = 'snapshot', updateCurrentParams }) {
    ...
    >
      ...
      <StickyPillsBar T={T} tab={tab} setTab={setTab} />
        ...
        {tab === 'trends' ? (
          <TrendsPanel
            T={T}
            trends={trends?.length ? trends : pollContext?.trendSeries || []}
