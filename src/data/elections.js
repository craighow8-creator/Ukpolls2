...
export const LOCAL_ELECTIONS = {
  ...
  councils: [
    ...
    {name:'Lancashire',         region:'North West',    type:'County',   control:'Reform', noc:false, seats:84,  majority:4,  lastFought:2025, watchFor:'Reform now runs Lancashire after the 2025 county elections. The question is whether it can look durable in office rather than just insurgent on the campaign trail.', verdict:'Reform-run county under pressure', difficulty:'hard'},
    ...
    {name:'North Yorkshire',    region:'Yorkshire',     type:'Unitary',  control:'Con',  noc:false, seats:90,  majority:30, lastFought:2023, watchFor:'A very large Conservative-led unitary authority. The key question is whether the current settlement still looks durable before the next full council election in 2027.', verdict:'Con-led county-scale authority', difficulty:'medium'},
    ...
    {name:'Liverpool',          region:'North West',    type:'Metropolitan', control:'Lab',  noc:false, seats:85,  majority:60, lastFought:2026, watchFor:'Liverpool remains firmly Labour-led, but ward-level movement still matters because smaller parties can keep building footholds in specific neighbourhoods.', verdict:'Labour city stronghold', difficulty:'safe'},
    ...
    {name:'Calderdale',         region:'Yorkshire',     type:'Metropolitan', control:'Lab',  noc:false, seats:51,  majority:12, lastFought:2024, watchFor:'Calderdale remains Labour-led, but the borough is politically mixed enough that Conservatives, Liberal Democrats, Reform and independents still shape the wider story.', verdict:'Labour defend in Calderdale', difficulty:'medium'},
    {name:'Kirklees',           region:'Yorkshire',     type:'Metropolitan', control:'NOC',  noc:true,  seats:69,  majority:0,  lastFought:2026, watchFor:'Kirklees is one of Yorkshire’s most fragmented councils. An all-out election makes that volatility much more important.', verdict:'Kirklees all-out battleground', difficulty:'very hard'},
    ...
    {name:'Wakefield',          region:'Yorkshire',     type:'Metropolitan', control:'Lab',  noc:false, seats:63,  majority:28, lastFought:2026, watchFor:'A whole-council reset puts every Wakefield seat in play at once and gives voters a much clearer chance to redraw the borough map.', verdict:'Whole-council reset in Wakefield', difficulty:'hard'},

    // South Yorkshire
    {name:'Barnsley',           region:'Yorkshire',     type:'Metropolitan', control:'Lab',  noc:false, seats:63,  majority:36, lastFought:2026, watchFor:'Barnsley has moved to a whole-council cycle, so every seat is up together in 2026 and shifts will show more clearly than under the old annual rhythm.', verdict:'Labour all-out test', difficulty:'medium'},
    ...
    {name:'Sheffield',          region:'Yorkshire',     type:'Metropolitan', control:'NOC',  noc:true,  seats:84,  majority:0,  lastFought:2023, watchFor:'Lab vs LD vs Green. Hallam area LD. Greens competitive in student wards.',              verdict:'NOC hold',            difficulty:'medium'},
    ...
    // Tyne & Wear
    {name:'Gateshead',          region:'North East',    type:'Metropolitan', control:'Lab',  noc:false, seats:66,  majority:34, lastFought:2026, watchFor:'An all-out election on a new ward map makes Gateshead more revealing than a routine metro cycle, even though Labour still starts from a position of strength.', verdict:'Labour all-out reset', difficulty:'medium'},
    ...
    {name:'North Tyneside',     region:'North East',    type:'Metropolitan', control:'Lab',  noc:false, seats:60,  majority:24, lastFought:2025, watchFor:'North Tyneside combines a directly elected Labour mayor with annual ward contests, so any slippage becomes politically visible quite quickly.', verdict:'Mayoral Labour defend', difficulty:'medium'},
    {name:'South Tyneside',     region:'North East',    type:'Metropolitan', control:'Lab',  noc:false, seats:54,  majority:30, lastFought:2026, watchFor:'An all-out election puts every seat in play at once. Labour leads, but the chamber is more plural than a lazy reading suggests.', verdict:'South Tyneside all-out test', difficulty:'hard'},
    {name:'Sunderland',         region:'North East',    type:'Metropolitan', control:'Lab',  noc:false, seats:75,  majority:30, lastFought:2026, watchFor:'All 75 seats are up after boundary review. Labour remains the lead force, but a full-chamber election can expose shifts much faster than the old cycle.', verdict:'Labour defend on new map', difficulty:'hard'},

    // ── UNITARY AUTHORITIES ─────────────────────────────────────────
    {name:'Durham',             region:'North East',    type:'County',   control:'NOC',  noc:true,  seats:126, majority:0,  lastFought:2025, watchFor:'County Durham does not vote in 2026, but the 2025 election changed the political leadership and the key question is whether the new administration beds in cleanly.', verdict:'No vote, but new county leadership', difficulty:'medium'},
    {name:'Northumberland',     region:'North East',    type:'County',   control:'Con',  noc:false, seats:69,  majority:4,  lastFought:2025, watchFor:'Northumberland is not voting in 2026, but it remains strategically important because it is a large county authority with a strong executive model and broad mixed geography.', verdict:'No vote, but strategic county authority', difficulty:'medium'},
    ...
    {name:'Stockton-on-Tees',   region:'North East',    type:'Unitary',  control:'NOC',  noc:true,  seats:56,  majority:0,  lastFought:2023, watchFor:'No vote in 2026, but Stockton remains politically mixed and its current leadership still has to hold together a more complicated chamber than a simple one-party reading suggests.', verdict:'No vote, but leadership worth tracking', difficulty:'medium'},
    {name:'Middlesbrough',      region:'North East',    type:'Unitary',  control:'Lab',  noc:false, seats:46,  majority:12, lastFought:2023, watchFor:'Middlesbrough is an elected-mayor authority, so the real focus is whether the Labour mayoral administration still looks stable between elections.', verdict:'Labour mayoralty to defend later', difficulty:'medium'},
    {name:'Redcar & Cleveland', region:'North East',    type:'Unitary',  control:'NOC',  noc:true,  seats:59,  majority:0,  lastFought:2023, watchFor:'Redcar and Cleveland is not voting in 2026, but it remains politically live because the borough is fragmented and the next all-out election could move quickly if one bloc gains momentum.', verdict:'No vote in a fragmented borough', difficulty:'hard'},
    {name:'Hartlepool',         region:'North East',    type:'Unitary',  control:'Lab',  noc:false, seats:36,  majority:4,  lastFought:2025, watchFor:'Hartlepool is still one of the most symbolically charged councils in the North East. Labour leads, but Reform has a visible local base and anti-establishment pressure is real.', verdict:'Labour-run Hartlepool under Reform pressure', difficulty:'very hard'},
    {name:'Darlington',         region:'North East',    type:'Unitary',  control:'NOC',  noc:true,  seats:50,  majority:0,  lastFought:2023, watchFor:'Darlington is not voting in 2026, but it remains a useful Tees-side bellwether because its current political settlement is mixed rather than locked down.', verdict:'No vote, but Tees-side bellwether', difficulty:'medium'},
    {name:'York',               region:'Yorkshire',     type:'Unitary',  control:'Lab',  noc:false, seats:47,  majority:10, lastFought:2023, watchFor:'York is more competitive than its headline Labour control suggests. The Liberal Democrats remain a credible alternative governing force.', verdict:'Labour-led city under watch', difficulty:'medium'},
    {name:'East Riding of Yorks',region:'Yorkshire',    type:'Unitary',  control:'Con',  noc:false, seats:67,  majority:16, lastFought:2023, watchFor:'A large Conservative-led rural and coastal authority. Local factors and independents still matter, but the Conservatives start from a clear lead.', verdict:'Conservative East Riding defend', difficulty:'medium'},
    {name:'Kingston upon Hull', region:'Yorkshire',     type:'Unitary',  control:'LD',   noc:false, seats:57,  majority:20, lastFought:2024, watchFor:'Hull is one of the clearest Liberal Democrat-led urban councils in the north, with Labour still close enough to matter.', verdict:'Liberal Democrat city defend', difficulty:'hard'},
    ...
    {name:'Cheshire West & Chester',region:'North West',type:'Unitary',  control:'Lab',  noc:false, seats:70,  majority:14, lastFought:2023, watchFor:'Labour has a clear lead, but the borough is broad enough that smaller parties and local independents still shape the wider picture.', verdict:'Labour defend in broad borough', difficulty:'medium'},
    {name:'Halton',             region:'North West',    type:'Unitary',  control:'Lab',  noc:false, seats:56,  majority:28, lastFought:2026, watchFor:'Halton remains Labour-led, but places like Runcorn mean it cannot just be dismissed as politically static.', verdict:'Labour hold with local pressure', difficulty:'medium'},
    ...
    {name:'Blackburn with Darwen',region:'North West',  type:'Unitary',  control:'Lab',  noc:false, seats:51,  majority:20, lastFought:2026, watchFor:'Labour remains the lead force, but challenger parties can still grow unevenly across different parts of the borough.', verdict:'Labour-led borough with pressure on the margins', difficulty:'medium'},
    {name:'Preston',            region:'North West',    type:'District', control:'Lab',  noc:false, seats:48,  majority:16, lastFought:2026, watchFor:'Preston is still Labour-led, but smaller parties and local campaign currents can still shape the feel of the result.', verdict:'Labour city defend', difficulty:'medium'},
...
export const LOCAL_REGIONS = [
  ...
  },
  {
    name: 'Yorkshire',
    emoji: '🌹',
    councils: 12, seats: 790,
    difficulty: 'hard',
    accentColor: '#E4003B',
    story: 'A politically mixed region, not just old Labour country. Bradford and Kirklees are fragmented battlegrounds, Wakefield and Barnsley are all-out resets, Hull is Lib Dem-led, and York remains a live Labour–Lib Dem city contest.',
    watchFor: 'Kirklees all-out volatility. Wakefield reset. Hull as a Lib Dem–Labour city fight. Doncaster and Rotherham pressure in the background.',
    councils_list: [
  ...
  },
  {
    name: 'North East',
    emoji: '⚓',
    councils: 12, seats: 807,
    difficulty: 'very hard',
    accentColor: '#12B7D4',
    story: 'The North East is still live for Reform pressure, but it is more mixed than a single insurgent story. Gateshead, Sunderland and South Tyneside are all-out resets, Hartlepool is a live Labour-versus-Reform test, and Durham and Northumberland matter even when they are not voting.',
    watchFor: 'Hartlepool as a Labour-versus-Reform test. Sunderland and Gateshead all-out resets. Tees-side medium-term volatility.',
    councils_list: [
...
export const COUNCIL_PROFILES = {
  ...
  'Doncaster': {
    ...
    seats:{total:55, ref:37, lab:12, con:6},
    seatsUp:0,
    ...
    mainContests:[
      ...
      'Whether Reform can hold together its 2025 breakthrough through to 2029',
      'Whether Labour can reassemble a local base before the next all-out cycle'
    ],
    whatCountsAsShock:'The next real shock threshold is not May 2026, but whether Reform’s current council dominance proves durable through to the 2029 all-out election while Labour still holds the mayoralty.',
    updatedAt:'2026-04-02',
    source:'City of Doncaster Council elections pages',
    lastElection:'Current official city council composition after the 2025 local elections: Reform UK 37, Labour 12, Conservative 6. The elected Mayor remains Ros Jones (Labour).'
  },
  'Rotherham': {
    control:'Lab',
    ...
    mainContests:[
      ...
      'Whether anti-Labour votes consolidate more effectively by the next cycle',
      'How far Reform can build a stronger local base before 2028'
    ],
    whatCountsAsShock:'There is no May 2026 borough-election shock available here; the real future shock would be Labour losing serious ground or overall control when Rotherham next votes all-out in 2028.',
    updatedAt:'2026-04-02',
    source:'Rotherham Metropolitan Borough Council elections and councillors pages',
    lastElection:'Rotherham has 59 councillors and next holds all-out borough elections on 4 May 2028.'
  },
  'Hartlepool': {
